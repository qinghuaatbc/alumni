    ...
    return (
      <div className="max-w-2xl mx-auto px-4 py-16 text-center">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12">
          ...
          <h2 className="text-xl font-bold text-gray-800 mb-2">No Profile Yet</h2>
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-white rounded-2xl shadow-md overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <h3 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-3">Career</h3>
              <div className="bg-gray-50 rounded-xl px-4">
      ...
      <div className="mt-4 text-center">
        <Link to={`/alumni/${profile.id}`} className="text-indigo-600 hover:text-indigo-800 text-sm font-medium">
          View public profile →
        </Link>
      </div>
    </div>
